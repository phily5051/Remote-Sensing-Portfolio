...
```{r echo=FALSE, out.width= "60%", out.height="40%", fig.show='hold', fig.align= 'center', fig.cap= 'Waterfront in Seoul (Source: [Seoul Metropolitan Government](https://mediahub.seoul.go.kr/archives/919167)'}
knitr::include_graphics('img/cheonggyecheon.jpg')
```

```{r echo=FALSE, out.width= "60%", out.height="40%", fig.show='hold', fig.align= 'center', fig.cap= 'Urban parks in Seoul (Source: [Kookmin Ilbo](https://m.kmib.co.kr/view.asp?arcid=0017350461))'}
