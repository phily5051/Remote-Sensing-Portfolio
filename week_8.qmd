...
```{r echo=FALSE, out.width='60%', fig.align='center', fig.cap="Difference in Temperature due to Urban Heat Island (Source: [US EPA](https://www.epa.gov/heatislands/learn-about-heat-islands), 2022)"}
...
```{r echo=FALSE, out.width='60%', fig.align='center', fig.cap="Urban Heat Island Effects and Factors (Source: [World Bank Blogs](https://blogs.worldbank.org/sustainablecities/3-ways-beat-heat-european-cities), 2020)"}
...
```{r echo=FALSE, out.width='60%', fig.align='center', fig.cap="Wind corridor forest map. (Source: [Seoul Metropolitan Government](https://flexible.img.hani.co.kr/flexible/normal/970/689/imgdb/original/2020/1014/20201014502292.jpg?_ga=2.54985771.1264888021.1678839871-1975413597.1678839871))"}
...
```{r echo=FALSE, out.width='60%', fig.align='center', fig.show='hold', fig.cap= "Mist spray and shade canopy (Source: [The JoongAng](https://www.joongang.co.kr/article/23534249), 2019)"}
knitr::include_graphics(c("img/mist_spray.jpg", "img/shade.jpg"))
```

-   Configuration of **urban waterfronts** and **urban parks**

```{r echo=FALSE, out.width='60%', fig.align='center', fig.show='hold', fig.cap= 'Waterfront and urban parks in Seoul (Source: left image by [Seoul Metropolitan Government](https://mediahub.seoul.go.kr/archives/919167) & right image by [Kookmin Ilbo](https://m.kmib.co.kr/view.asp?arcid=0017350461))'}
...
```{r echo=FALSE, out.width='60%', fig.align='center', fig.cap= "UN SDG 11 - Global Policy (Source: [United Nations](https://sdgs.un.org/goals))"}
