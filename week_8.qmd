...
library(cowplot)
ggdraw() + 
  draw_image('img/mist_spray.jpg', width = 0.5) + 
  draw_image('img/shade.jpg', width = 0.5, x = 0.5)
```
...
ggdraw() + 
  draw_image('img/cheonggyecheon.jpg', width = 0.5) + 
  draw_image('img/park.jpg', width = 0.5, x = 0.5)
```
