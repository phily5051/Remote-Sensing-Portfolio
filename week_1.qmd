...
|                | -   can observe areas under most conditions as most active sensors operate in the microwave band of the |
...
In the context of climate change, the ability to map tree types are important as they are closely linked to biodiversity. As mentioned earlier, each feature has different spectral signatures. @durgante2013 have discovered that
